<template>
    ...
    <v-container>
        ...
        <div v-if="situaties.length==0">
          ...
          <p class="font-weight-light text-grey text-darken-2 text-center">
            Je hebt nog geen situaties. Maak een situatie om je voortgang bij te houden!
          </p>

          <v-btn class="mt-3" color="primary" elevation="2" block large to="/nieuwe-situatie">
            Maak een situatie
          </v-btn>
