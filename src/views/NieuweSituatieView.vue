    ...
    <v-container>
        ...
        <v-row v-show="!hideButtons">
            ...
            <v-col>
                ...
                <v-btn color="primary" elevation="2" block @click="hideButtons=true, nieuweKaart('Gedachte')">
                    Gedachte
                </v-btn>
            ...
            <v-col>
                ...
                <v-btn color="primary" elevation="2" block @click="hideButtons=true, nieuweKaart('Emotie')">
                    Emotie
                </v-btn>
            ...
            <v-col>
                ...
                <v-btn color="primary" elevation="2" block @click="hideButtons=true, nieuweKaart('Actie')">
                    Actie
                </v-btn>
        ...
        <v-row v-if="hideButtons">
            ...
            <v-col>
                ...
                <v-btn color="primary" elevation="2" block large :disabled="kaarten[kaarten.length-1].waarde == ''" @click="nieuweKaart(volgendeSoort)">
                    {{ volgendeSoort }}
                </v-btn>
            ...
            <v-col>
                ...
                <v-btn color="primary" elevation="2" block large :disabled="situatieTitel == ''" @click="opslaan()">
                    Opslaan
                </v-btn>
